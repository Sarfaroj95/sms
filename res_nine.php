...
if(isset($_POST['sub']))
{
  ...
  $qer=mysqli_query($conn,"insert into result_nine values('$roll','$nam','$dob','$fnam','$ben','$eng','$math','$phy','$geo','$his','$tot')");

  if($qer)
  {
     echo "<script> alert('Successfull Marks..'); window.location.href='result_class_nine.php';</script>";
                }
                else
                {
                   echo "<script> alert('Unsuccessfull Marks..'); window.location.href='res_nine.php';</script>";
                }
...
<body bgcolor="lightyellow">
	...
	<div class="header_left">
		...
		<a href="result_class_nine.php"><img src="headeta.png" class="header_img"></a> 
    ...
    <div class="body">
    	<div class="menu">
    		      ...
    		      <b class="header_text">  *****Marks Class - IX*****</b>

           
    	  
    		
    	</div>  <br><br>
      <div class="frm_heading"> Class-IX</div>
       <?php
                $id=$_GET['id'];
               include "connection.php";
