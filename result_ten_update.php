...
if(isset($_POST['sub']))
{
  ...
  $update=mysqli_query($conn,"UPDATE `result_ten` SET bengali='$b', english='$eng', math='$math', phy='$phy', geo='$geo', his='$his', total='$total'  where id='$a'");
  ...
  <div class="header_left">
    ...
    <div class="body">
      <div class="menu">
              ...
              <b class="header_text">  *****Update Marks Class - X*****</b>
      ...
      <div class="frm_heading"> Class-X</div>
       <?php
                ...
                $qer=mysqli_query($con,"select * from result_ten where id='$a'");
