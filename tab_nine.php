...
<body class="back">
	...
	<div class="hd">Class IX Student List</div>
	  ...
	  <td class="tdh"><?php echo $res['fname'];  ?></td>
	   <td class="tdh"><?php echo $res['address'];  ?></td>
	    ...
	    <td style="text-align: center;">
	    	<a href="tab_nine_update.php?id=<?php echo $res['id']; ?>">
	    	<input type="button" name="" value="Update" class="tdb"></a></td>
     

      <td style="text-align: center;"><a href="tab_nine_delete.php?id=<?php echo $res['id']; ?>" ><input type="button" name="" value="Delete" class="tdd" ></a></td>
