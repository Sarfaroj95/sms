...
<body bgcolor="lightyellow">
    ...
    <div class="body">
    	<div class="menu">
    		      ...
    		      <b class="header_text">  *****Class Five Student list*****</b>
...
?>
  ...
  <tr>
    ...
    <td class="tdh" style="text-align: center;">
        <a href="res_five.php?id=<?php echo $res['id']; ?>">
        <input type="button" name="" value="Add Marks" class="tdb"></a></td>

     <td style=" text-align:  center;"><a href="result_five_update.php?id=<?php echo $res['id']; ?>"><input " type="button" name="" value="Update" class="tdb"></a></td>
