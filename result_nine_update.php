...
if(isset($_POST['sub']))
{
  ...
  $update=mysqli_query($conn,"UPDATE `result_nine` SET bengali='$b', english='$eng', math='$math', phy='$phy', geo='$geo', his='$his', total='$total'  where id='$a'");
  ...
  <div class="header_left">
    ...
    <div class="body">
      <div class="menu">
              ...
              <b class="header_text">  *****Update Marks Class - IX*****</b>
      ...
      <div class="frm_heading"> Class-IX</div>
       <?php
                ...
                $qer=mysqli_query($con,"select * from result_nine where id='$a'");
