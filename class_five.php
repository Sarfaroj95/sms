...
if(isset($_POST['submit']))
{
  ...
  $tot=$_POST['total'];
     ...
     $qer=mysqli_query($conn,"INSERT INTO class_five VALUES('','$name','$gender','$fnam','$mnam','$add','$pin','$mail','$mob','$dob','$age','$school','$tong','$rel','$income','$ben','$eng','$math','$phy','$geo','$his','$tot',now())");
...
border-top-right-radius: 8px; "  >Admission Form Class-V</div>
  ...
  <form method="post"  style="margin-left: 60px; padding-top: 20px;" >
    ...
    <td><t>Student's Name:</t></td><td> <input type="text" name="nm" required="require"  > <br></td>
      ...
      <tr>
    <td><t>Gender:</t></td><td><input type="radio" name="gen" value="male" required="require" ><a class="mm"> Male</a>
