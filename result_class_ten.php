...
?>
  ...
  <tr>
    ...
    <td class="tdh" style="text-align: center;">
        <a href="res_ten.php?id=<?php echo $res['id']; ?>">
        <input type="button" name="" value="Add Marks" class="tdb"></a></td>

     <td style=" text-align:  center;"><a href="result_ten_update.php?id=<?php echo $res['id']; ?>"><input " type="button" name="" value="Update" class="tdb"></a></td>
