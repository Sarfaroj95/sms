...
$id=$_GET['id'];
$qer=mysqli_query($conn,"select * from class_nine where id='$id'");
...
?>
	...
	<div class="header_logo"><a href="tab_nine.php"> <img src="slicon.png" style="width: 50px; height: 50px; margin-top: 10px;"></a></div>
...
border-top-right-radius: 8px; margin-top: -55px; margin-left: 100px; "  >Update Class-IX</div>

  <div class="frm" style="background: #79d26c; width: 600px; height: 470px;border-color: black; border-bottom-right-radius: 8px;
...
if(isset($_POST['sub']))
{
	...
	$qer=mysqli_query($conn,"update class_nine set sname='$nam', gender='$s',
	...
	if($qer)
	{
		...
		window.location.href='tab_nine.php';</script>";
	}
}
