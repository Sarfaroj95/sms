...
$qer=mysqli_query($conn,"select * from report ");
...
<tr>
	<td class="tdh" style="width: 10px;"><?php echo $c++;?></td>
	 <td class="tdh"><?php echo $res['student_name'];  ?></td>
	  <td class="tdh"><?php echo $res['class'];  ?></td>
	   <td class="tdh"><?php echo $res['roll'];  ?></td>
	   <td class="tdh"><?php echo $res['report']; ?></td>
	   <td class="tdh"><?php echo $res['date'] ?></td>
	    <td style="text-align: center;"><a href="report_delete.php?id=<?php echo $res['id']; ?>" ><input type="button" name="" value="Delete" class="tdd" ></a></td>
