...
if(isset($_POST['sub']))
{
  ...
  $update=mysqli_query($conn,"UPDATE `result_five` SET bengali='$b', english='$eng', math='$math', phy='$phy', geo='$geo', his='$his', total='$total'  where id='$a'");
  ...
  <div class="header_left">
    ...
    <div class="body">
      <div class="menu">
              ...
              <b class="header_text">  *****Update Marks Class - V*****</b>
      ...
      <div class="frm_heading"> Class-V</div>
       <?php
                ...
                $qer=mysqli_query($con,"select * from result_five where id='$a'");
