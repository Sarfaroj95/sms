...
if(isset($_POST['sub']))
{
  ...
  $qer=mysqli_query($conn,"insert into result_five values('$roll','$nam','$dob','$fnam','$ben','$eng','$math','$phy','$geo','$his','$tot')");

  if($qer)
  {
     echo "<script> alert('Successfull Marks..'); window.location.href='result_class_five.php';</script>";
                }
                else
                {
                   echo "<script> alert('Unsuccessfull Marks..'); window.location.href='res_five.php';</script>";
                }
...
<body bgcolor="lightyellow">
	...
	<div class="header_left">
		...
		<a href="result_class_five.php"><img src="headeta.png" class="header_img"></a> 
    ...
    <div class="body">
    	<div class="menu">
    		      ...
    		      <b class="header_text">  *****Marks Class - V*****</b>
