...
if(isset($_POST['sub']))
{
  ...
  $qer=mysqli_query($conn,"insert into result_six values('$roll','$nam','$dob','$fnam','$ben','$eng','$math','$phy','$geo','$his','$tot')");

  if($qer)
  {
     echo "<script> alert('Successfull Marks..'); window.location.href='result_class_six.php';</script>";
                }
                else
                {
                   echo "<script> alert('Unsuccessfull Marks..'); window.location.href='res_six.php';</script>";
                }
...
<body bgcolor="lightyellow">
    ...
    <div class="body">
    	<div class="menu">
    		      ...
    		      <b class="header_text">  *****Marks Class - VI*****</b>
