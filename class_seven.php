...
if(isset($_POST['submit']))
{
  ...
  $tot=$_POST['total'];
     ...
     $qer=mysqli_query($conn,"INSERT INTO class_seven VALUES('','$name','$gender','$fnam','$mnam','$add','$pin','$mail','$mob','$dob','$age','$school','$tong','$rel','$income','$ben','$eng','$math','$phy','$geo','$his','$tot',now())");
...
border-top-right-radius: 8px; "  >Admission Form Class-VII</div>
